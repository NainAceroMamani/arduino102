...
');
        $ui->assign('xfooter', '
<script type="text/javascript" src="' . $_theme . '/lib/select2/select2.min.js"></script>'.Asset::js(array('locale')).'
');
...
//    API Support from Version 3
    ...
    case 'activate_license_post':
        ...
        $url_string = '?ng=';
		$lic = md5(APP_URL.$url_string);


        $data = array();
		$data['status'] = 'Active';
		$data['license_key'] = $lic;
		$data['msg'] = 'Activated Successfully';
