...
// a timestamp is generated
                ...
                case 'ccavenue':
                    ...
                    if($p){
                        ...
                        require ('sysfrm/lib/misc/ccform.php');
  ...
  <input type="submit" value="Pay '.$config['currency_code'].' '.$vamount .'">
                ...
                case 'quickpay':
                    ...
                    if($p){
                        ...
                        require 'sysfrm/lib/misc/quickpay.php';
...
//                        $ui->display('client-ipay.tpl');
    ...
    case 'ccsubmit':
        ...
        if($p) {
            ...
            require('sysfrm/lib/misc/ccsubmit.php');
    ...
    case 'forgot_pw_post':
        ...
        if($d){
            ...
            $password = Ibstr::random_string(8);
    ...
    case 'register_post':
       ...
       // sleep(3);
        ...
        Event::trigger('client_register_post');
...
//        $ = _post('');
    ...
    case 'profile':
        ...
        $ui->assign('_sysfrm_menu', 'profile');
