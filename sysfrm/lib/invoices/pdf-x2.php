    ...
    <table width="100%">
        <tr>
            ...
            <td style="border: 0;  text-align: right" width="62%"><div id="logo" style="font-size:18px">
                    <img id="image" src="<?php echo APP_URL; ?>/sysfrm/uploads/system/logo.png" alt="logo" /> <br> <br>
...
<hr>
        ...
        <table id="meta">
            ...
            if($d['credit'] != '0.00'){
                ...
                <tr>
                    ...
                    <td><div class="due"><?php echo ib_money_format($i_due,$config); ?></div></td>
                </tr>
    ...
    <table id="items">
        ...
        if (($d['tax']) != '0.00'){
            ...
            <tr>
                ...
                <td class="total-value"><div id="total"><?php echo ib_money_format($d['tax'],$config); ?></div></td>
            </tr>
        <?php
        }
        ?>
        ...
        if($d['credit'] != '0.00'){
            ...
            <tr>
                ...
                <td class="total-value"><div class="due"><?php echo ib_money_format($d['total'],$config); ?></div></td>
            </tr>
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line"><?php echo $_L['Total Paid']; ?></td>
                <td class="total-value"><div class="due"><?php echo ib_money_format($d['credit'],$config); ?></div></td>
            </tr>
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line balance"><?php echo $_L['Amount Due']; ?></td>
                <td class="total-value balance"><div class="due"><?php echo ib_money_format($i_due,$config); ?></div></td>
            </tr>
        <?php
        }
        else{
    ...
    if ($trs_c != ''){
        ...
        <table id="related_transactions" style="width: 100%">
            ...
            <td align="right"><span class="price">'.ib_money_format($tr['amount'],$config).'</span></td>
        </tr>';
            }
