...
<div id='main-container'>
    ...
    <div class="span12">
        ...
        if (version_compare(PHP_VERSION, '5.3.0') >= 0) {
            ...
            $ltext .= 'To Run '.$app_name.' You need at least PHP version 5.3.0, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---FAILED---</strong><br/>";
            $passed .= '0';
...
<div class="footer">Copyright &copy; <?php echo date('Y'); ?> All Rights Reserved | <a href="https://fire2000.rocks">Nulled by fire2000</a><br/>
    <br/>
</div>
</body>
</html>
